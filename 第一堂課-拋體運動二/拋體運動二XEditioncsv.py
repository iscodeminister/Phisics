...
csvFile = open('xout.csv','w',newline='') #csv
Writer = csv.writer(csvFile)
Writer.writerow(['V0 Speed','Ball','Distance'])
...
for speed in range(1,11):
	...
	ballblabel = label(pos=ball_b.pos,
	    ...
	    height=8, border=1,
	    font='sans')
	print("初速為",v0,"時,球A飛了",ball_a.pos.x,"公尺",sep='')
	print("初速為",v0,"時,球B飛了",ball_b.pos.x,"公尺",sep='')
	Writer.writerow([v0,"A",ball_a.pos.x])
	Writer.writerow([v0,"B",ball_b.pos.x])
