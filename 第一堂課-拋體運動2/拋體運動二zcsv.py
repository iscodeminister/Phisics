...
"""
L=30 #箱子長度
scene = canvas(title="拋體運動二", width=1600, height=900, x=0, y=0)
...
ball_b = sphere(radius=radius,make_trail=True,pos=vector(end,bally,0.2),interval=10,color=color.yellow) #考慮空氣阻力的球
